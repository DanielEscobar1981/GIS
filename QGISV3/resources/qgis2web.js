...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 32, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [-56715288.000000, -29264809.000000, 20037508.342789, 20037508.342789],
            units: 'degrees'})
    })
});
...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_ModBasicosJunio2020V2_2,
      colName: 'localidad',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-60.579006, -30.660283, -53.849364, -27.010844], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="Daniel Escobar V1">Desarrollo Marma Informatica</a>';
